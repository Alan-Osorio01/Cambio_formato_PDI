...
{
    string frgRoot = FRG_ROOT;
    string trainListFilePath = frgRoot + "/list/train_list.txt";
    ...
    namedWindow("Face Recognisation", WINDOW_NORMAL);
        ...
        while ( getFrame.getNextFrame(frame) ) {
            ...
            if ( key != -1 ) {
                if ( (key & 255) == 27) {
                    ...
                    facesCount++;
                    string tempPath = frgRoot + "/faces/temp/s";
