...
{
    String face_cascadePath = string(FRG_ROOT) + "/haarcascade/haarcascade_frontalface_default.xml";
    String eyes_cascadePath = string(FRG_ROOT) + "/haarcascade/haarcascade_eye.xml";
